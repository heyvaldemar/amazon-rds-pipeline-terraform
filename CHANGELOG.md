...
- **A test of what the configuration promises, and proof that the test can fail.** `tests/posture.tftest.hcl` plans the configuration with its default variables against mocked providers and makes 21 assertions about what it would build; `tests/plant_violations.py` breaks them 15 ways on a copy and requires the test to notice each. Both run in CI on every push. The README's Testing section also lists, plainly, what the defaults do not promise.
...
[Unreleased]: https://github.com/heyvaldemar/amazon-rds-pipeline-terraform/compare/v1.1.5...HEAD
[1.1.5]: https://github.com/heyvaldemar/amazon-rds-pipeline-terraform/compare/v1.1.4...v1.1.5
[1.1.4]: https://github.com/heyvaldemar/amazon-rds-pipeline-terraform/compare/v1.1.3...v1.1.4
[1.1.3]: https://github.com/heyvaldemar/amazon-rds-pipeline-terraform/compare/v1.1.2...v1.1.3
[1.1.2]: https://github.com/heyvaldemar/amazon-rds-pipeline-terraform/compare/v1.1.1...v1.1.2
[1.1.1]: https://github.com/heyvaldemar/amazon-rds-pipeline-terraform/compare/v1.1.0...v1.1.1
[1.1.0]: https://github.com/heyvaldemar/amazon-rds-pipeline-terraform/compare/v1.0.0...v1.1.0
[1.0.0]: https://github.com/heyvaldemar/amazon-rds-pipeline-terraform/releases/tag/v1.0.0
